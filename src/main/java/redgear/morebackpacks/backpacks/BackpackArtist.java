...
public class BackpackArtist extends BasicBackpack
{
    ...
    {
        String colors[] = {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey",
                           "Grey", "LightGray", "Gray", "Pink", "Lime", "Yellow", "LightBlue", "Magenta",
                           "Orange", "White", "Cloud", "DarkGrey"
                          };
