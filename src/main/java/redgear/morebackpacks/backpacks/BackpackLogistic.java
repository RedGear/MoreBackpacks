...
public class BackpackLogistic extends BasicBackpack
{
	...
	public void fill()
    {
        ...
        if (Mods.Railcraft.isIn())
        {
            ...
            String[] cartTypes = {"basic", "chest", "furnace", "tnt", "anchor", "anchor.admin", "anchor.personal", "bore",
                                  "energy.batbox", "energy.mfe", "energy.mfsu", "gift", "loco.steam",
                                  "pumpkin", "tank", "tnt.wood", "track.relayer", "undercutter", "work"
                                 };
        ...
        if (Mods.BuildcraftCore.isIn())
        {
            ...
            String materials[] = {"Wood", "Emerald", "Stone", "Cobblestone", "Iron", "Gold", "Diamond", "Obsidian", "Void", "Sandstone", "Quartz", "Lapis", "Daizuli"};
    ...
    {
        return "Logistical Engineer's Backpack";
    }
